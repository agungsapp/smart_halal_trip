      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0"> <img class="mb-4"
              src="{{ asset('images') }}/dark-logo.png" width="150" alt="jadoo" />
          ...
          <div class="col-lg-2 col-md-4 mb-4 mb-lg-0 order-lg-3 order-md-4">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-2"><a class="link-900 fs-1 fw-medium text-decoration-none" href="#!">Airlinefees</a>
              </li>
          ...
          <div class="col-lg-3 col-md-5 col-12 mb-4 mb-md-6 mb-lg-0 order-lg-4 order-md-1">
            ...
            <div class="d-flex align-items-center"> <a href="#!"> <img class="me-2"
                  src="{{ asset('user') }}/assets/img/play-store.png" alt="play store" /></a><a href="#!"> <img
                  src="{{ asset('user') }}/assets/img/apple-store.png" alt="apple store" /></a></div>
          </div>
        </div>
