...
<body>
  ...
  <main class="main" id="top">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 hero-img"
              src="{{ asset('user') }}/assets/img/hero/hero-img.png" alt="hero-header" /></div>
          <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
            <h4 class="fw-bold text-danger mb-3">Wisata Halal yang Nyaman & Terpercaya</h4>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="card shadow" style="border-radius:10px;">
                      <div class="position-absolute start-0 top-0 translate-middle">
                        <img class="rounded-circle fit-cover"
                          src="{{ asset('user') }}/assets/img/testimonial/user1.png" height="65" width="65"
                          alt="" />
                      </div>
                  ...
                  <div class="carousel-item position-relative">
                    <div class="card shadow" style="border-radius:10px;">
                      <div class="position-absolute start-0 top-0 translate-middle">
                        <img class="rounded-circle fit-cover"
                          src="{{ asset('user') }}/assets/img/testimonial/user2.png" height="65" width="65"
                          alt="" />
                      </div>
                      <div class="card-body p-4">
                  ...
                  <div class="carousel-item position-relative">
                    <div class="card shadow" style="border-radius:10px;">
                      <div class="position-absolute start-0 top-0 translate-middle">
                        <img class="rounded-circle fit-cover"
                          src="{{ asset('user') }}/assets/img/testimonial/user3.png" height="65" width="65"
                          alt="" />
                      </div>
                      <div class="card-body p-4">
    ...
    <div class="py-5 text-center">
      <p class="mb-0 text-secondary fs--1 fw-medium">Gia @ darmajaya </p>
    </div>
  </main>
  <!-- ===============================================-->
  <!--    End of Main Content-->
